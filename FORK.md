...
| Remote execution/cache | Makes very large builds practical in CI | `OUT` by D-019 unless explicitly requested |
...
| Development/release/repository support surface | Nix/devenv, BuildBuddy, cross-compilation, OCI/tar, release/install, ZLS, buildifier/formatting, assets, contribution/docs structure | Contributor, release, and deployment conveniences | Build product capabilities directly; add individual surfaces only on request | `OUT` by D-019 unless explicitly requested |
